...
load(paste0(stub, "results/regressions/for_projections/usa_dmcf.RData"))
...
gadm_0 <- st_as_sf(geodata::gadm(country=countryiso3, level=0, path=tempdir()))
gadm_1 <- st_as_sf(geodata::gadm(country=countryiso3, level=1, path=tempdir()))
