...
load(paste0(stub, "results/regressions/for_projections/ind_dmcf.RData"))
...
gadm <- read_sf(paste0(stub, "data/shapefiles/India/Adm_level_1_states/gadm36_IND_1.shp"))
...
gadm_0 <- st_as_sf(readRDS(paste0(stub, "data/projections/new_data_jan_2022/gadm36_IND_0_sp.rds")))
gadm_1 <- st_as_sf(readRDS(paste0(stub, "data/projections/new_data_jan_2022/gadm36_IND_1_sp.rds")))
...
gadm_1$state3 <- gadm_1$NAME_1

regional_summary_ac <- stringdist_join(regional_summary_ac, gadm_1, 
                                by = "state3",
                                mode = "left",
                                ignore_case = TRUE, 
                                method = "jw", 
