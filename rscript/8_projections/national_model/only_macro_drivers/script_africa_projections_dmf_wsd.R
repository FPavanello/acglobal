...
custom_shape$country <- gadm$ID_0
...
ely_formula <- "ln_ely_q ~ ac + curr_CDD18_db +  ln_total_exp_usd_2011 +  urban_sh + n_members + ownership_d + edu_head_2 +   housing_index_lab + age_head + sex_head"
