...
data_c_sp <- merge(data_c_sp, cmip6_merged, by.x="adm1", by.y="state")
...
for (ssp in c("SSP2", "SSP5")){
  ...
  orig_data_bk <- HH_China[obs(reg_ac),]
...
orig_data$housing_index_lab = (data_c_sp[,paste0("housing_index_lab_", year, "_s1")])
