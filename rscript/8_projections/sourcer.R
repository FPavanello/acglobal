...
lapply(list.files("C:/Users/falchetta/Downloads/acglobal/rscript/8_projections/global_model/", pattern = "script", recursive=F, full.names = T)[-6], source, echo=T)

# # global projections, global model
lapply(list.files("C:/Users/Utente/Downloads/acglobal/rscript/8_projections/global_model/only_macro_drivers", pattern = "script", recursive=F, full.names = T)[6], source, echo=T)