...
if (user=='edc') {
  stub <- "F:/Il mio Drive/ENERGYA/6-Projections/"
}
...
load(paste0(stub, "repo/interm/ita_dmcf.RData"))
...
gadm <- read_sf(paste0(stub, "data/shapefiles/Italy/gadm40_ITA_1.shp"))
...
gadm_0 <- st_as_sf(readRDS(paste0(stub, "data/projections/new_data_jan_2022/gadm36_ITA_0_sp.rds")))
gadm_1 <- st_as_sf(readRDS(paste0(stub, "data/projections/new_data_jan_2022/gadm36_ITA_1_sp.rds")))
