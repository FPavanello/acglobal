...
for (ssp in c("SSP2", "SSP5")){
  ...
  for (year in seq(2020, 2050, 10)){
    ...
    #
    projected <- predict(model7, orig_data)
...
write.csv(national_summary_ac_bycountry, paste0(stub, "results/household_level/", countryiso3, "_national_ac_penetration_bycountry_glomod.csv"))
write.csv(national_summary_cons_bycountry,  paste0(stub, "results/household_level/", countryiso3, "_national_ac_consumption_bycountry_glomod.csv"))
write.csv(national_summary_total_bycountry,  paste0(stub, "results/household_level/", countryiso3, "_national_ac_consumption_total_bycountry_glomod.csv"))
...
write.csv(national_summary_cons_totelectr_bycountry,  paste0(stub, "results/household_level/", countryiso3, "_national_ely_consumption_bycountry_glomod.csv"))
