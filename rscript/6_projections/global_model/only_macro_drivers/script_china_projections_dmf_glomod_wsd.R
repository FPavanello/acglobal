...
ely_formula <- "ln_ely_q ~ ac + curr_CDD18_db + ln_total_exp_usd_2011 + curr_HDD18_db + urban_sh + n_members + as.factor(ownership_d) + edu_head_2 + sh_under16 + housing_index_lab + age_head + sex_head"
